...
1.A/B & Hypothesis Testing (T-test): Used to compare the mean conversions of both platforms. A T-test was performed to determine if the performance gap was significant enough to reject the null hypothesis.
